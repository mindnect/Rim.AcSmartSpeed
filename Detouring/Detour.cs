    ...
    public static class Detour
    {
        ...
        **/
        ...
        public static unsafe bool TryDetourFromTo(MethodInfo source, MethodInfo destination)
        {
            ...
            var sourceString = source.DeclaringType.FullName + "." + source.Name + " @ 0x" + source.MethodHandle.GetFunctionPointer().ToString("X" + IntPtr.Size*2);
            var destinationString = destination.DeclaringType.FullName + "." + destination.Name + " @ 0x" + destination.MethodHandle.GetFunctionPointer().ToString("X" + IntPtr.Size*2);
